...
const commentList = (props) => {  
    ...
    let fil=props.comments.filter(c=>c.shout_id==="cbfd8946-7d45-4952-b95b-74922fd08a50")
    console.log(props.comments.find(c=>c.shout_id==="b954d35a-de0d-42b4-a021-7f9c61ec0673"));
    ...
    <div>
        ...
        // )}
          ...
          <tr key={k}>
            ...
            <td>{item.date.substring(12, 19)} p.m.</td>
          </tr>
